...
import { ADMIN_ADDRESS, PANCHADFARM_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 56,
    strategies: [{ name: 'ChadFarm', params: { symbol: 'ChadFarm', address: getCakeAddress(), decimals: 18 } }],
  }
}
