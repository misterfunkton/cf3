...
const StyledBuyTicketButton = styled(BuyTicketsButton)<{ disabled: boolean }>`
  background: ${({ theme, disabled }) =>
    disabled ? theme.colors.disabled : 'linear-gradient(180deg, #95a9e0 0%, #5583ad 100%)'};
  width: 200px;
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <StarsDecorations display={['none', 'none', 'block']}>
        <img src="/images/lottery/chadcorn.png" width="124px" height="109px" alt="" />
        <img src="/images/lottery/chickenpepe.png" width="70px" height="62px" alt="" />
        <img src="/images/lottery/chadfarmer.png" width="130px" height="144px" alt="" />
        <img src="/images/lottery/cow.png" width="123px" height="83px" alt="" />
        <img src="/images/lottery/chadcorn.png" width="121px" height="72px" alt="" />
      </StarsDecorations>
