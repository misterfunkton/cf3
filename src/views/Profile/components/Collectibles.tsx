  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('ChadFarm Collectibles')}
      </Heading>
      <Text as="p">
        {t('ChadFarm Collectibles are special ERC-721 NFTs that can be used on the ChadFarm platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved ChadFarm Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved ChadFarm Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
